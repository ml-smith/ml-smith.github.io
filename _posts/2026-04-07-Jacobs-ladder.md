...
<img src="{{site.url}}/assets/images/circuit-diagram.svg" align="left" style="border:none; border-radius: 7px; width:50%;" alt="image">
<img src="{{site.url}}/assets/images/circuit-structure.jpg" align="right" style="border:none; border-radius: 7px; width:50%;" alt="image">
<br>
<br>
</div>
