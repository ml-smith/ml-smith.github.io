...
<img src="{{site.url}}/assets/images/circuit-diagram.svg" align="left" style="border:none; border-radius: 7px; width:175px;" alt="image">
<img src="{{site.url}}/assets/images/circuit-structure.jpg" align="right" style="border:none; border-radius: 7px; width:125px;" alt="image">
<br>
<br>
</div>
